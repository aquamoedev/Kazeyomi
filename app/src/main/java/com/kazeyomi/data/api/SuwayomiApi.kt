...
interface SuwayomiApi {
    ...
    @GET("api/v1/library")
    suspend fun getLibrary(@Query("categoryId") categoryId: Int? = null): MangasResponse
    ...
    @GET("api/v1/sources")
    suspend fun getSources(@Query("installed") installed: Boolean? = null): SourcesResponse
    ...
    suspend fun getSourcePreferences(
        @Path("sourceId") sourceId: String
    ): Map<String, String>?

    @POST("api/v1/source/{sourceId}/preferences")
    suspend fun saveSourcePreferences(
        @Path("sourceId") sourceId: String,
        @Body preferences: Map<String, @JvmSuppressWildcards String>
    )
    ...
    @GET("api/v1/updates")
    suspend fun getUpdates(@Query("since") since: Long? = null): UpdatesResponse
    ...
    suspend fun deleteHistory(@Path("historyId") historyId: Int)
